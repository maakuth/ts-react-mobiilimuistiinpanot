...
export const SparklesIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 24 24" fill="currentColor">
    <path d="M12 2.69l.94 2.22 2.33.25-1.75 1.58.49 2.37-2.01-1.22L10 10.33l.49-2.37-1.75-1.58 2.33-.25L12 2.69zm-5 6.31l.94 2.22 2.33.25-1.75 1.58.49 2.37-2.01-1.22L5 15.33l.49-2.37-1.75-1.58 2.33-.25L7 9zm10 0l.94 2.22 2.33.25-1.75 1.58.49 2.37-2.01-1.22L15 15.33l.49-2.37-1.75-1.58 2.33-.25L17 9zm-5 7l.94 2.22 2.33.25-1.75 1.58.49 2.37-2.01-1.22L10 22.33l.49-2.37-1.75-1.58 2.33-.25L12 16z" />
  </svg>
);
